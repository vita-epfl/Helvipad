...
class BasicMotionEncoder(nn.Module):
    def __init__(self, cfg):
        ...
        self.cfg = cfg
        cor_planes = cfg.corr_levels * (2*cfg.corr_radius + 1) * (8+1)
...
class BasicMultiUpdateBlock(nn.Module):
    def __init__(self, cfg, hidden_dims=[]):
        ...
        self.gru04 = ConvGRU(hidden_dims[2], encoder_output_dim + hidden_dims[1] * (cfg.n_gru_layers > 1))
        self.gru08 = ConvGRU(hidden_dims[1], hidden_dims[0] * (cfg.n_gru_layers == 3) + hidden_dims[2])
